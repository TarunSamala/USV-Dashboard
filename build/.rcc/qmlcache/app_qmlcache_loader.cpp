...
namespace _0x5f_Dashboard_qml_Main_qml { 
...
Registry::Registry() {
    resourcePathToCachedUnit.insert(QStringLiteral("/Dashboard/qml/Main.qml"), &QmlCacheGeneratedCode::_0x5f_Dashboard_qml_Main_qml::unit);
